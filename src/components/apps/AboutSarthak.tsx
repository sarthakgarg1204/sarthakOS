...
import { BookOpen, Code2, FileText, Rocket, User } from "lucide-react";
        ...
        return (
          <div className="w-full flex flex-col items-center justify-start py-6 px-4 md:px-8 text-white select-none">
            ...
            <div className="text-center text-lg md:text-2xl leading-tight pt-6">
              <div>
                my name is{" "}
                <span className="font-bold text-white">Sarthak Garg</span>,
              </div>
              <div>
                I&apos;m a{" "}
              ...
              <div className="px-4 bg-opacity-5 backdrop-blur-sm rounded-md transition-all hover:border-white/30">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-sm md:text-base leading-relaxed">
                    I&apos;m a <strong>Computer Science undergrad</strong> at
                    JMIT (Batch 2026), passionate about building intelligent
                    systems and impactful digital experiences.
                  </p>
                </div>
              </div>
              <div className="px-4 bg-opacity-5 backdrop-blur-sm rounded-md transition-all hover:border-white/30">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-sm md:text-base leading-relaxed">
                    ...
                    , I built{" "}
                    <a
                      href="https://github.com/sarthakgarg1204/carbon-nigrani"
                      target="_blank"
              ...
              <div className="px-4 bg-opacity-5 backdrop-blur-sm rounded-md transition-all hover:border-white/30">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-sm md:text-base leading-relaxed">
                    I developed{" "}
                    <a
                      href="https://kropgenie.streamlit.app"
                      target="_blank"
                      className="underline text-blue-400"
                    >
                      CropGenie
                    </a>{" "}
                    — a real-time AI recommender system.
                  </p>
                </div>
              </div>
              <div className="px-4 bg-opacity-5 backdrop-blur-sm rounded-md transition-all hover:border-white/30">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-sm md:text-base leading-relaxed">
                    I specialize in{" "}
                    <strong>MERN, TypeScript, scalable APIs</strong>, and
                    production AI integration with Flask & Scikit-learn.
                  </p>
                </div>
              </div>
              <div className="px-4 bg-opacity-5 backdrop-blur-sm rounded-md transition-all hover:border-white/30">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-sm md:text-base leading-relaxed">
                    I believe in learning fast, building fast, and solving with
                    empathy.
                  </p>
                </div>
              </div>
            ...
            <div className="mt-6 text-sm text-gray-300 text-center">
              ...
              •{" "}
              <a
                href="https://linkedin.com/in/sarthakgarg1204"
                target="_blank"
                className="underline text-blue-400"
              >
                LinkedIn
              ...
              •{" "}
              <a
                href="https://sarthakgarg1204.github.io"
                target="_blank"
                className="underline text-blue-400"
              >
                Portfolio
        ...
        return (
          <div className="space-y-6 w-full md:w-4/5 mx-auto text-sm md:text-base">
            ...
            {[
              ...
              <div
                key={idx}
                className="bg-white/5 border border-white/10 backdrop-blur-sm rounded-md p-4 hover:border-white/20 transition-all"
              >
        ...
        return (
          <div className="w-full flex flex-col items-center text-white py-6 space-y-6">
            ...
            <ul className="tracking-tight text-sm md:text-base w-11/12 text-center text-gray-300 space-y-3">
              <li>
                I’ve worked with a variety of languages, tools, and frameworks
                to build scalable, intelligent, and visually polished
                applications.
              </li>
              <li>
